...
```{r, engine='cat', engine.opts=list(file='snare-drum-roll.ly')}
\version "2.18.2"
...
mkdir ./temp-lilypond
cd temp-lilypond
lilypond -dbackend=eps -dno-gs-load-fonts -dinclude-eps-fonts -dpixmap-format=pngalpha --png ../snare-drum-roll.ly &>all.log
cp snare-drum-roll.png ../../images/snare-drum-roll.png # copy the image in jekyll images directory 
cd ..
rm -r temp-lilypond
rm snare-drum-roll.ly
```
...
```{r test-cat, engine='cat', engine.opts=list(file='cycle-fifth.ly')}
\language "deutsch"
%%
...
mkdir ./temp-lilypond
cd temp-lilypond
lilypond -dbackend=eps -dno-gs-load-fonts -dinclude-eps-fonts -dpixmap-format=pngalpha --png ../cycle-fifth.ly &>all.log
cp cycle-fifth.png ../../images/cycle-fifth.png # copy the image in jekyll images directory 
cd ..
rm -r temp-lilypond
rm cycle-fifth.ly
```
